...
html += '<div id="jspsych-image-resize-response-handle" style="cursor: move; background-color: black; width: 14px; height: 150px; border: 2px solid black; position: absolute; bottom: 0; right: 0; "></div>';
